        ...
        <div className="p-6 space-y-6 bg-white min-h-full text-slate-800 font-sans select-none">
            <header className="flex items-center justify-between border-b border-blue-100 pb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-slate-900">Digital Governance Agency</h1>
                        <p className="text-xs text-blue-600 font-mono">Department of Government Affairs • dga.gov</p>
                    </div>
                </div>
