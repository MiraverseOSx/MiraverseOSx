            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  {f.count > 0 && (
                    <span className={`text-[10px] font-mono rounded px-1.5 py-0.2 ${
                      activeFolder === f.id ? 'bg-[#5f6ab0] text-white' : 'bg-slate-200 text-slate-600'
                    }`}>
                      {f.count}
                    </span>
                  )}
            ...
            {filteredEmails.map((mail) => {
              ...
              return (
                <div
                  ...
                  className={`group relative cursor-pointer rounded-xl border p-3 transition shadow-xs ${
                    isSelected
          ...
          {selectedMail ? (
            <div className="flex h-full flex-col space-y-4">
              ...
              <div className="rounded-2xl border border-slate-300/80 bg-white p-5 shadow-sm space-y-3">
                ...
                {/* Body Content Box */}
                <div className="text-xs leading-relaxed text-[#243064] whitespace-pre-line font-serif leading-6 bg-[#FAF9FF] p-4 rounded-xl border border-purple-200/50">
                  {selectedMail.body}
                </div>
              </div>
