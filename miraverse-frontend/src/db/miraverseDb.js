...
export const APPS = [
  ...
  { id: 'passport', title: 'Aura Passport', category: 'Utility/Identity', dev: 'FAC_NEO_CITIZENS', version: '1.1.0', primary: 'Student profile, aura status, and medical registry', lore: 'Displays clearance and active aura networks.' },
