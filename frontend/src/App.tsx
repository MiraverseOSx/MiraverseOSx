    ...
    <div className="flex flex-col h-screen overflow-hidden bg-slate-950 text-slate-100 font-sans selection:bg-sky-500/30">
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        <button
          ...
          className="fixed bottom-14 right-4 z-50 p-2.5 bg-sky-600 hover:bg-sky-500 text-white rounded-full shadow-xl border border-sky-400 transition-transform active:scale-95"
