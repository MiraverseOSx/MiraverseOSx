import { Folder, Mail, MessageSquare, Terminal, Globe, Settings, Sparkles, UserCheck, Radio, Award, BookOpen, Cpu, Home, Briefcase, Activity, Package, Building, LucideIcon } from 'lucide-react';
